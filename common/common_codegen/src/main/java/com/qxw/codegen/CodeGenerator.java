...
public class CodeGenerator {
     ...
     * 代码所在系统
     */
    private String systemName = SABER_NAME;
    /**
     * 代码模块名称
     */
     ...
     * 代码所在服务名
     */
    private String serviceName = "him-codegen";
    /**
     * 代码生成的包名
     */
    private String packageName = "com.zw.zwzc.modules.event";
    /**
     * 代码后端生成的地址
     */
     ...
     * 需要生成的表名(两者只能取其一)
     */
    private String[] includeTables = {"GG_ZD"};
    /**
     * 需要排除的表名(两者只能取其一)
     */
    ...
    public void run() {
        ...
        if (StrUtil.containsAny(driverName, DbType.ORACLE.getDb())) {
        ...
        if (hasSuperEntity) {
            strategy.setSuperEntityClass("com.jrlife.core.mp.base.BaseEntity");
            strategy.setSuperEntityColumns(superEntityColumns);
            strategy.setSuperServiceClass("com.jrlife.core.mp.base.BaseService");
            strategy.setSuperServiceImplClass("com.jrlife.core.mp.base.BaseServiceImpl");
            // 自定义 controller 父类
            strategy.setSuperControllerClass("com.jrlife.core.boot.ctrl.BladeController");
        } else {
...
//        });
        ...
        if (StrUtil.isNotBlank(packageWebDir)) {
            if (StrUtil.equals(systemName, SWORD_NAME)) {
            ...
            } else if (StrUtil.equals(systemName, "SABER_NAME")) {
    ...
    public String getOutputDir() {
        return (StrUtil.isBlank(packageDir) ? System.getProperty("user.dir") + "/common/common_codegen" : packageDir) + "/src/main/java";
    }
