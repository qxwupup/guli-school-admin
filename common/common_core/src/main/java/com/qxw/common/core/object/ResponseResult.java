package com.qxw.common.core.object;

import cn.hutool.json.JSONUtil;
import com.qxw.common.core.constant.ErrorCodeEnum;
import com.qxw.common.core.utils.ContextUtil;
import lombok.Data;
...
public class ResponseResult<T> {
    ...
    public static <T> void output(int httpStatus, ResponseResult<T> responseResult) throws IOException {
        if (httpStatus != HttpServletResponse.SC_OK) {
            ...
            log.info(JSONUtil.toJsonStr(responseResult));
        }
