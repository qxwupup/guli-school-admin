...
import com.qxw.common.core.utils.HttpClientUtils;
...
import com.qxw.ucenter.utils.ConstantWxUtils;
...
@Tag(name = "微信扫码登录相关接口", description = "微信扫码登录相关接口")
public class WxApiController {
    ...
    @GetMapping("callback")
    @Operation(summary = "获取扫描人信息，添加数据", description = "获取扫描人信息，添加数据")
